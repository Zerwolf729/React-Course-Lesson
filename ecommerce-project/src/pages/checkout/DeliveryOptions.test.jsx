...
describe("DeliveryOptions component", () => {
  ...
  it("renders delivery options correctly", () => {
    ...
    expect(deliveryOptionElems[0]).toHaveTextContent(
      formatDate(deliveryOptions[0].estimatedDeliveryTimeMs)
    );
    ...
    expect(deliveryOptionElems[1]).toHaveTextContent(
      formatDate(deliveryOptions[1].estimatedDeliveryTimeMs)
    );
    ...
    expect(deliveryOptionElems[2]).toHaveTextContent(
      formatDate(deliveryOptions[2].estimatedDeliveryTimeMs)
    );
